...
import {stratSetStratWeek} from '../actions/statrWeek';
import {stratSetEndWeek} from '../actions/endWeek';
import {stratSetOrderReceived} from '../actions/orderReceived';
import {stratSetWorkersCount} from '../actions/workersCount';
...
export class LoginPage extends React.Component {
  ...
  componentWillMount() { //didmount
    // this.props.startSetWeeklyOrder();
     this.props.stratSetStratWeek();
     this.props.stratSetEndWeek();
     this.props.stratSetOrderReceived();
     this.props.stratSetWorkersCount();
  };
...
const mapDispatchToProps = (dispatch) => ({
  ...
  stratSetStratWeek: () => dispatch(stratSetStratWeek()),
  stratSetEndWeek: () => dispatch(stratSetEndWeek()),
  stratSetOrderReceived: () => dispatch(stratSetOrderReceived()),
  stratSetWorkersCount: () => dispatch(stratSetWorkersCount())
